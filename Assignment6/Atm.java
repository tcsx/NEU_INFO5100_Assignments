...
public class Atm implements Serializable {
    ...
    public boolean askIfNew(Scanner sc) {
        System.out.println(
                "Are you a new user? If you are a new user, please enter \"yes\". If you are a current user, please enter \"no\".");
    ...
    public String createNewAccount(Scanner sc) {
        ...
        try {
            ...
            UserInfo newUser = new UserInfo(password, new User(name, age, address, phoneNumber, num), 0,
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Now choose your operation by entering an operation name. Available operations are availableBalance, withDrawal, deposit, recentTransactions, changePassword and exit.");
        String operation = "";
